...
export default async function CoursePage({
  ...
  const completedModules =
    course.modules_list?.filter((module) => module.completed).length || 0
  ...
  return (
    <div className="container px-4 py-12 md:py-24">
      <Link
        href="/learn"
        className="inline-flex items-center text-sm text-zinc-600 dark:text-zinc-400 hover:text-black dark:hover:text-white mb-6"
      >
            ...
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-6">
              <div>
                <div className="flex items-center space-x-2 mb-2">
                  <Badge className={`${course.iconBg} text-white`}>
                    {course.level}
                  </Badge>
                  {course.featured && (
            ...
            <div className="space-y-4">
              {course.modules_list ? (
                course.modules_list.map((module, index) => (
                  ...
                  >
                    <Card
                      className={`bg-white/50 dark:bg-zinc-800/50 border border-zinc-300 dark:border-zinc-700 hover:border-zinc-400 dark:hover:border-zinc-600 transition-colors ${
                        module.completed
                ...
                <div className="text-center py-8">
                  <p className="text-zinc-600 dark:text-zinc-400 mb-4">
                    Module details will be available when you enroll in this
                    course.
                  </p>
                  <Button className="bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-700 hover:to-pink-700 text-white">
                    Enroll Now
        ...
        <div>
          <div className="bg-zinc-100/50 dark:bg-zinc-900/50 border border-zinc-300 dark:border-zinc-800 rounded-xl p-6 mb-8">
            ...
            <ul className="space-y-2">
              {[
                "Fundamentals of permanent storage on Arweave",
                "How to build decentralized applications",
                "Working with autonomous compute on AO",
          ...
          <div className="bg-purple-100/30 dark:bg-purple-900/20 border border-purple-300 dark:border-purple-900/30 rounded-xl p-6">
